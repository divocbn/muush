...
export default function SidebarEverythingElse() {
  return (
    <div className="flex flex-col max-w-40 w-fit gap-10 z-10">
      <div className="flex flex-col gap-3 w-full">
        <div className="h-4 w-full items-center justify-center flex">
          <Home className="w-3" strokeWidth={2.7} />
        </div>
      ...
      <div className="flex flex-col gap-3 w-full">
        <div className="h-4 w-full items-center justify-center flex">
          <ChartGantt className="w-3" strokeWidth={2.7} />
        </div>
      ...
      <div className="flex flex-col gap-3 w-full">
        <div className="h-4 w-full items-center justify-center flex">
          <Globe className="w-3" strokeWidth={2} />
        </div>
